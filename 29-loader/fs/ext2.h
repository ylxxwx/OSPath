...
2. sector layout
 ...
 |             |   block 1   |   block 2   |
 | boot |      |super block  |group description
...
3. First block offset is in the partition table.
4. How many blocks for group description/inode is calculation by num of desp/inode * size()/block size.
...
#define SUPER_BLOCK_SIZE (sizeof(struct ext2_super_block))
#define GROUP_DESC_SIZE (sizeof(struct ext2_group_desc));
#define INODE_SIZE (sizeof(struct ext2_inode));
#define DIR_ENTRY_SIZE (sizeof(struct ext2_dir_entry_2));
