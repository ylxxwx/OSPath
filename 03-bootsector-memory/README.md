...
With [org 0x7c00], all labels' address becomes [offset + 0x7c000]. Since the binary is loaded into 0x7c00. If we want to use these labels, use the label directly.

With [org 0x7c00], all labels' address becomes [offset]. Since the binary is loaded into 0x7c00. If we want to use these labels, we need to use [label + 0x7c00] or load DS with 0x7c0.
