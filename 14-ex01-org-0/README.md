...
This task we use [org 0] for bootsect.asm, and set cs/ds/es/ss to 0x7C00, move kernel to ds:0x200.
Pay attention to changes in code about `0x7C0`.

This change helps undertand the label in asm code and the segments without start address 0x0000.